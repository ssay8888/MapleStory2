...
class Pants final : public GameObject
{
public:
	Pants(const ComPtr<IDirect3DDevice9>& device);
	~Pants() override;
public:
...
public:
	static auto Create(const ComPtr<IDirect3DDevice9>& device)->std::shared_ptr<Pants>;
