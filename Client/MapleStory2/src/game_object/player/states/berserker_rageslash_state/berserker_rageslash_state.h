...
class BerserkerRageslashState final : public CharacterState
{
public:
	~BerserkerRageslashState() override = default;
	static auto GetInstance()->std::shared_ptr<BerserkerRageslashState>
	{
		static auto instance = std::make_shared<BerserkerRageslashState>();
		return instance;
	}
