...
class Hair final : public GameObject
{
public:
	Hair(const ComPtr<IDirect3DDevice9>& device);
	~Hair() override;
public:
...
public:
	static auto Create(const ComPtr<IDirect3DDevice9>& device)->std::shared_ptr<Hair>;
